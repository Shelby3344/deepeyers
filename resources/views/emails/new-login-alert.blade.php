...
<head>
    ...
    <title>Novo Login Detectado - DeepEyes</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.5);">
                    ...
                    <tr>
                        <td style="padding: 0;">
                            <div style="background: linear-gradient(135deg, rgba(6, 182, 212, 0.2), rgba(59, 130, 246, 0.2)); padding: 20px 40px; border-left: 4px solid #06b6d4;">
                                <h2 style="margin: 0; color: #22d3ee; font-size: 20px; font-weight: 600;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #cbd5e1; font-size: 16px; line-height: 1.6;">
                                Detectamos um novo login na sua conta a partir de um dispositivo ou localização diferente.
                            </p>
                            
                            <div style="background: rgba(6, 182, 212, 0.1); border: 1px solid rgba(6, 182, 212, 0.3); border-radius: 12px; padding: 20px; margin: 30px 0;">
                                <h3 style="margin: 0 0 15px; color: #06b6d4; font-size: 16px; font-weight: 600;">
                                    📍 Detalhes do acesso:
                                </h3>
                                <table style="width: 100%; color: #cbd5e1; font-size: 14px;">
                                    <tr>
                                        <td style="padding: 8px 0; color: #94a3b8; width: 120px;">Data/Hora:</td>
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #94a3b8;">Localização:</td>
                            ...
                            <div style="background: rgba(239, 68, 68, 0.05); border: 1px solid rgba(239, 68, 68, 0.2); border-radius: 12px; padding: 20px; margin: 30px 0;">
                                <p style="margin: 0; color: #fca5a5; font-size: 14px; line-height: 1.6;">
                                    ...
                                    Recomendamos que você altere sua senha imediatamente e entre em contato conosco pelo WhatsApp: 
                                    <a href="https://wa.me/5511940968290" style="color: #ef4444; text-decoration: none; font-weight: 600;">+55 11 94096-8290</a>
                                </p>
                            </div>
                            
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="https://deepeyes.online/profile" style="display: inline-block; padding: 14px 40px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
